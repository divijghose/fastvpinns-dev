...
from fastvpinns.domain_decomposition.dd_utils.print_utils import *
...
class DDGeometry_2D():
    ...
    def generate_conv_domains(self, x_limits, y_limits, n_cells_x: int, n_cells_y: int, kernel_size_row: int, kernel_size_col: int, stride_row: int, stride_col: int):
        ...
        self.n_cells_x = n_cells_x
        self.n_cells_y = n_cells_y
        print("[INFO] : Generating Convolutional Domains")
        print("----------------------------")
        print(f"[INFO] : x_limits = {x_limits}")
        print(f"[INFO] : y_limits = {y_limits}")
        print(f"[INFO] : n_cells_x = {n_cells_x}")
        print(f"[INFO] : n_cells_y = {n_cells_y}")
        ...
        self.domain_info_printer = DomainInfoPrinter(self.domains, self.xmin_list, self.xmax_list, self.ymin_list, self.ymax_list, self.x_mean_list, self.y_mean_list, self.x_span_list, self.y_span_list)

        print("[INFO] : Domain Information")
        print("----------------------------")
        print("Basic Info")
        self.domain_info_printer.print_basic_info()
        print("Subdomain Table")
        self.domain_info_printer.print_subdomain_table()
        print("Parameter Table")
        self.domain_info_printer.print_parameter_table()
        print("----------------------------")
        print("[INFO] : Domain Information")
        self.domain_info_printer.print_domain_info()
    ...
    def print_domain_info(self):
        ...
        print_table_multicolumns(title, str(cols), 
